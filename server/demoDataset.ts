import type { ScenarioKind, TrendPoint } from "../shared/smartPump";
...
export function createDeterministicDemoTrend(scenario: ScenarioKind, windowMinutes: number): TrendPoint[] {
  const liveTrend = createTrend(scenario, windowMinutes);
